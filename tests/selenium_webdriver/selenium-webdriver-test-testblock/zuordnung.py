...
class Zuordnung(unittest.TestCase):
    ...
    def test_zuordnung(self):
        ...
        Select(driver.find_element_by_name("test_id")).select_by_visible_text("Test 5 (1 Fragen)")
        driver.find_element_by_name("save").click()
        try: self.assertEqual("Ordne die Fraben", driver.find_element_by_css_selector("p.question").text)
