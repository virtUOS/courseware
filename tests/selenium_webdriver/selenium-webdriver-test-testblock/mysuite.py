...
def suite():
    ...
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromName('singlechoice'))
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromName('multiplechoice'))
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromName('janein'))
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromName('freieantwort'))
    test_suite.addTest(unittest.defaultTestLoader.loadTestsFromName('zuordnung'))
