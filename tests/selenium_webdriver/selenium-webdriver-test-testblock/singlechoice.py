...
class Singlechoice(unittest.TestCase):
    def setUp(self):
    ...
    def test_singlechoice(self):
        ...
        try: self.assertRegexpMatches(driver.find_element_by_css_selector("p.question").text, r"^exact:Was ist die Antwort auf alles[\s\S]$")
