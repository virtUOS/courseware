            ...
            if (static::$vipsPlugin === null) {
                ...
                if (static::$vipsPlugin) {
                    \PageLayout::addStylesheet(static::$vipsPlugin->getPluginURL() .'/css/vips_style.css');
                           \PageLayout::addHeadElement('script', array(), "VIPS_CHARACTER_PICKER = '".
                                                       \PluginEngine::getLink(static::$vipsPlugin, array('action' => 'sheets', 'subaction' => 'get_character_picker_ajax'), 'show') . "';");
