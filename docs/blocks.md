...
Diagramm
--------
Mit dem Diagramm-Block können unkompliziert Diagramm erstellt werden, diese werden bei der Darstellung animiert.

![Autorenansicht des Diagramm-Blocks](img/diagrammBlock_edit.png)
_Autorenansicht des Diagramm-Blocks_

![Studentenansicht des Diagramm-Blocks](img/diagrammBlock.png)
_Studentenansicht des Diagramm-Blocks_
...
Embed
-----
Mit diesem Block lassen sich Inhalte von diversen Plattformen in Courseware einbinden.

![Autorenansicht des Embed-Blocks](img/embedBlock_edit.png)
_Autorenansicht des Embed-Blocks_

![Studentenansicht des Embed-Blocks](img/embedBlock.png)
_Studentenansicht des Embed-Blocks_
...
Zur Kennzeichnung der Inhalte können Creative Commons angaben gemacht werden.
...
Interactive Video
-----------------
Mit dem InteractiveVideo-Block lassen sich während ein Video abgespielt wird Texte einblenden, Haltepunkte mit Text stoppen die Wiedergabe
 und Aufgaben aus Vips lassen sich direkt im Video bearbeiten. Texte können in verschiedenen vordefinierten Formaten dargestellt und positioniert werden.

![Autorenansicht des InteractiveVideo-Blocks](img/iav_edit.png)
_Autorenansicht des InteractiveVideo-Blocks_

![Studentenansicht des InteractiveVideo-Blocks](img/iav.png)
_Studentenansicht des InteractiveVideo-Blocks_
...
Lernkarten
----------
Der Lernkarten-Block kann ein Set beliebig vieler Karten enthalten. Auf die Vorder- und Rückseite
einer Karte kann ein Bild und ein Text gesetzt werden. Der Lernende kann durch die Karten blättern und jede Karte umdrehen.

![Autorenansicht des Lernkarten-Blocks](img/dialogCardBlock_edit.png)
_Autorenansicht des Lernkarten-Blocks_

![Studentenansicht des Lernkarten-Blocks](img/dialogCardBlock.png)
_Studentenansicht des Lernkarten-Blocks_
...
Opencast
--------
In Verbindung mit dem Opencast-Plugin können Opencast-Videos abgespielt werden. Wahlweise kann der Opencast-Player verwendet werden.

![Autorenansicht des Opencast-Blocks](img/openCastBlock_edit.png)
_Autorenansicht des Opencast-Blocks_

![Studentenansicht des Opencast-Blocks](img/openCastBlock.png)
_Studentenansicht des Opencast-Blocks_
